...
/// Replace contest with the name of your module
    ...
    add_to_log($course->id, "monitorgroup", "view all", "index.php?id=$course->id", "");


/// Get all required strings

    $strmonitors = get_string("modulenameplural", "monitorgroup");
    $strmonitor  = get_string("modulename", "monitorgroup");
