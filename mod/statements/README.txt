...
///////////////////////////////////////////////////////////////////////////
//                                                                       //
// statements module original code                                             //
...
statements module for Moodle - version 1.1 (stable release)
===============================================================================
Created by:
...
Installation:
    ...
    2/ download statements.zip to your moodle/mod directory and unzip it there
...
Intentionally omitted features:
    ...
    * more chapter levels - it would encourage teachers to write too much
      complex and long statementss, better use standard standalone HTML editor and
      import it as Resource. Docstatements format is another suitable solution.
    ...
    * PDF export - there is no elegant way AFAIK to convert HTML to PDF,
      use virtual PDF printer or better use Docstatements format for authoring
    * detailed student tracking (postponed till officially supported)
    * export as zipped set of HTML pages - instead use browser command
      Save page as... in print view

Future:
    * I like eXe editor, I would like to improve statements in this direction ... ;-)
...
== 1.3alpha - 2006/03/12 ======================================================
    ...
    * moved to contrib/statements_16 directory
